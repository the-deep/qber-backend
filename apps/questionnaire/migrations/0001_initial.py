    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('priority_levels', django.contrib.postgres.fields.ArrayField(base_field=models.PositiveSmallIntegerField(choices=[(1, 'High'), (2, 'Medium'), (3, 'Low')]), blank=True, default=list, size=None)),
                ('enumerator_skills', django.contrib.postgres.fields.ArrayField(base_field=models.PositiveSmallIntegerField(choices=[(1, 'Basic'), (2, 'Intermediate'), (3, 'Advanced')]), blank=True, default=list, size=None)),
                ('data_collection_methods', django.contrib.postgres.fields.ArrayField(base_field=models.PositiveSmallIntegerField(choices=[(1, 'Key informant interview'), (2, 'Direct observation'), (3, 'Automatic observation')]), blank=True, default=list, size=None)),
            ],
            options={
                'abstract': False,
            },
